		...
		if (!file.isEmpty()) {
			try {
				...
				BufferedOutputStream buffStream = new BufferedOutputStream(new FileOutputStream(
						new File("C:/Users/USER/Documents/newhomedeco/src/main/webapp/resources/images/" + fileName)));
...
//			return new ModelAndView( "redirect:/products");
		...
		File oldName = new File("C:/Users/USER/Documents/newhomedeco/src/main/webapp/resources/images/" + fileName);
		File newName = new File("C:/Users/USER/Documents/newhomedeco/src/main/webapp/resources/images/"+ product.getId()
	...
	@RequestMapping("categorydetails/{id}")
